...
#  (19). Optional: challenges/scripts/run_all_challenges.sh (if FULL_VALIDATION=1)
#
...
echo "[1/18] constitution/ directory exists"
...
echo "[2/18] constitution/Constitution.md §11.4 anchor"
...
echo "[3/18] constitution/CLAUDE.md anti-bluff covenant anchor"
...
echo "[4/18] constitution/AGENTS.md anti-bluff covenant anchor"
...
echo "[5/18] Parent CLAUDE.md inheritance pointer"
...
echo "[6/18] Parent AGENTS.md inheritance pointer"
...
echo "[7/18] Parent CONSTITUTION.md inheritance pointer"
...
echo "[8/18] Parent CLAUDE.md §11.4 propagation anchor"
...
echo "[9/18] Parent AGENTS.md §11.4 propagation anchor"
...
echo "[10/18] Parent CONSTITUTION.md §11.4 propagation anchor"
...
echo "[11/18] .claude/settings.json with PreToolUse guard hook"
...
echo "[12/18] docs/AGENT_GUARDRAILS.md SUBAGENT CONSTITUTIONAL PREAMBLE"
...
echo "[13/18] docs/AGENT_GUARDRAILS.md ORCHESTRATOR PRE-ACTION CHECKLIST"
if [[ -f "${GUARDRAILS_FILE}" ]] && \
...
echo "[14/18] constitution/scripts/hooks/guard-forbidden-commands.sh"
...
echo "[15/18] tests/hooks/test_guard_forbidden_commands.sh"
...
echo "[16/18] CM-MARKDOWN-EXPORT-SYNC: all-Markdown export freshness (§11.4.65)"
...
echo "[18/18] CM-DOCS-CHAIN-VALIDATE: docs_chain.sh --check-only (§11.4.106)"
