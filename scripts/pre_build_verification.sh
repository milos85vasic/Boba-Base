...
#  (16). Optional: challenges/scripts/run_all_challenges.sh (if FULL_VALIDATION=1)
#
# Constitution: §1.1 (paired mutation), §11.4 (anti-bluff covenant), §11.4.125 (code-review gate), §11.4.109 (anti-forgetting enforcement)
...
echo "[1/15] constitution/ directory exists"
...
echo "[2/15] constitution/Constitution.md §11.4 anchor"
...
echo "[3/15] constitution/CLAUDE.md anti-bluff covenant anchor"
...
echo "[4/15] constitution/AGENTS.md anti-bluff covenant anchor"
...
echo "[5/15] Parent CLAUDE.md inheritance pointer"
...
echo "[6/15] Parent AGENTS.md inheritance pointer"
...
echo "[7/15] Parent CONSTITUTION.md inheritance pointer"
...
echo "[8/15] Parent CLAUDE.md §11.4 propagation anchor"
...
echo "[9/15] Parent AGENTS.md §11.4 propagation anchor"
...
echo "[10/15] Parent CONSTITUTION.md §11.4 propagation anchor"
...
echo "[11/15] .claude/settings.json with PreToolUse guard hook"
...
echo "[12/15] docs/AGENT_GUARDRAILS.md SUBAGENT CONSTITUTIONAL PREAMBLE"
...
echo "[13/15] docs/AGENT_GUARDRAILS.md ORCHESTRATOR PRE-ACTION CHECKLIST"
if [[ -f "${GUARDRAILS_FILE}" ]] && \
...
echo "[14/15] constitution/scripts/hooks/guard-forbidden-commands.sh"
...
echo "[15/15] tests/hooks/test_guard_forbidden_commands.sh"
