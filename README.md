...
<p align="center">
  <img alt="tests"          src="https://img.shields.io/badge/python%20tests-6068%20collected-blue">
  ...
  <img alt="pre-build"      src="https://img.shields.io/badge/pre--build%20invariants-56-blue">
...
- Python unit + e2e + contract (`pytest` — 4947 tests collected, see docs/TESTING.md)
