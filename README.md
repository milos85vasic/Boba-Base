...
<p align="center">
  <img alt="tests"          src="https://img.shields.io/badge/python%20tests-6164%20collected-blue">
...
- Python unit + e2e + contract (`pytest` — 5003 tests collected, see docs/TESTING.md)
