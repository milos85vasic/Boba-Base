...
export interface ServerConfig {
  ...
  /** Base URL of the qBitTorrent WebUI (e.g., http://localhost:8080) */
  readonly url: string;
...
export interface AutoDiscoveryConfig {
  ...
  /** Whether to scan for qBitTorrent directly (port 8080) */
  readonly scanQbittorrent: boolean;

  /** Whether to scan for Boba FastAPI (port 7187) */
