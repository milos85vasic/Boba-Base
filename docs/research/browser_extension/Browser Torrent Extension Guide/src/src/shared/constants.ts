 ...
 */
export const TORRENT_FILE_VALIDATION_REGEX =
  /^https?:\/\/.+\.torrent(\?.*)?$/i;
 ...
 * These supplement the generic magnet: and .torrent detection.
 */
export const SITE_SELECTORS: Readonly<
