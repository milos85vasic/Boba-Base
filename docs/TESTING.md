...
Contributing-section bullets. Last regenerated: 2026-09-25T14:12:03Z.

| Suite | Directory | Real count | Method |
|---|---|---|---|
| Python (whole `tests/` tree) | `tests/` | **6316** | `pytest --collect-only -q` |
| Python unit | `tests/unit/` | **5033** | `pytest --collect-only -q` |
| Python integration | `tests/integration/` | **316** | `pytest --collect-only -q` |
