...
Contributing-section bullets. Last regenerated: 2026-09-22T18:55:05Z.

| Suite | Directory | Real count | Method |
|---|---|---|---|
| Python (whole `tests/` tree) | `tests/` | **6023** | `pytest --collect-only -q` |
| Python unit | `tests/unit/` | **4885** | `pytest --collect-only -q` |
