...
Contributing-section bullets. Last regenerated: 2026-08-21T15:33:55Z.

| Suite | Directory | Real count | Method |
|---|---|---|---|
| Python (whole `tests/` tree) | `tests/` | **5437** | `pytest --collect-only -q` |
| Python unit | `tests/unit/` | **4432** | `pytest --collect-only -q` |
...
| Pre-build invariants | `scripts/pre_build_verification.sh` | **46** | max total of every `[N/N]` progress label |
