...
Contributing-section bullets. Last regenerated: 2026-09-22T23:34:18Z.

| Suite | Directory | Real count | Method |
|---|---|---|---|
| Python (whole `tests/` tree) | `tests/` | **6068** | `pytest --collect-only -q` |
| Python unit | `tests/unit/` | **4903** | `pytest --collect-only -q` |
...
| Pre-build invariants | `scripts/pre_build_verification.sh` | **56** | max total of every `[N/N]` progress label |
