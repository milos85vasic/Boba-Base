...
Contributing-section bullets. Last regenerated: 2026-09-23T09:31:49Z.

| Suite | Directory | Real count | Method |
|---|---|---|---|
| Python (whole `tests/` tree) | `tests/` | **6164** | `pytest --collect-only -q` |
| Python unit | `tests/unit/` | **4959** | `pytest --collect-only -q` |
