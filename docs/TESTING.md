...
Contributing-section bullets. Last regenerated: 2026-09-25T09:14:13Z.

| Suite | Directory | Real count | Method |
|---|---|---|---|
| Python (whole `tests/` tree) | `tests/` | **6271** | `pytest --collect-only -q` |
| Python unit | `tests/unit/` | **5033** | `pytest --collect-only -q` |
| Python integration | `tests/integration/` | **309** | `pytest --collect-only -q` |
