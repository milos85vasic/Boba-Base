...
Contributing-section bullets. Last regenerated: 2026-08-25T19:41:48Z.

| Suite | Directory | Real count | Method |
|---|---|---|---|
| Python (whole `tests/` tree) | `tests/` | **5617** | `pytest --collect-only -q` |
| Python unit | `tests/unit/` | **4529** | `pytest --collect-only -q` |
...
| Pre-build invariants | `scripts/pre_build_verification.sh` | **51** | max total of every `[N/N]` progress label |
