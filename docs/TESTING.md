...
Contributing-section bullets. Last regenerated: 2026-08-18T22:29:25Z.

| Suite | Directory | Real count | Method |
|---|---|---|---|
| Python (whole `tests/` tree) | `tests/` | **5248** | `pytest --collect-only -q` |
| Python unit | `tests/unit/` | **4391** | `pytest --collect-only -q` |
...
| HelixQA Challenges | `challenges/scripts/*.sh` | **31** | `ls challenges/scripts/*.sh \| wc -l` |
| Pre-build invariants | `scripts/pre_build_verification.sh` | **25** | max total of every `[N/N]` progress label |
