...
Contributing-section bullets. Last regenerated: 2026-08-19T12:01:00Z.

| Suite | Directory | Real count | Method |
|---|---|---|---|
| Python (whole `tests/` tree) | `tests/` | **5263** | `pytest --collect-only -q` |
...
| HelixQA Challenges | `challenges/scripts/*.sh` | **35** | `ls challenges/scripts/*.sh \| wc -l` |
