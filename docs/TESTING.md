...
Contributing-section bullets. Last regenerated: 2026-09-22T08:42:01Z.

| Suite | Directory | Real count | Method |
|---|---|---|---|
| Python (whole `tests/` tree) | `tests/` | **6024** | `pytest --collect-only -q` |
| Python unit | `tests/unit/` | **4886** | `pytest --collect-only -q` |
