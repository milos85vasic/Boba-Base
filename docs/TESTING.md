...
Contributing-section bullets. Last regenerated: 2026-08-25T20:20:41Z.

| Suite | Directory | Real count | Method |
|---|---|---|---|
| Python (whole `tests/` tree) | `tests/` | **5618** | `pytest --collect-only -q` |
...
| Pre-build invariants | `scripts/pre_build_verification.sh` | **52** | max total of every `[N/N]` progress label |
