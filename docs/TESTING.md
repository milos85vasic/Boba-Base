...
Contributing-section bullets. Last regenerated: 2026-08-19T11:24:27Z.

| Suite | Directory | Real count | Method |
|---|---|---|---|
| Python (whole `tests/` tree) | `tests/` | **5260** | `pytest --collect-only -q` |
...
| HelixQA Challenges | `challenges/scripts/*.sh` | **32** | `ls challenges/scripts/*.sh \| wc -l` |
