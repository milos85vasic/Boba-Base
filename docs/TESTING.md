...
Contributing-section bullets. Last regenerated: 2026-08-21T19:51:58Z.

| Suite | Directory | Real count | Method |
|---|---|---|---|
| Python (whole `tests/` tree) | `tests/` | **5499** | `pytest --collect-only -q` |
| Python unit | `tests/unit/` | **4454** | `pytest --collect-only -q` |
...
| Pre-build invariants | `scripts/pre_build_verification.sh` | **49** | max total of every `[N/N]` progress label |
