...
- **559 automated tests pass** (across 52 test files); the code also passes its type
...
**HEAD:** `5edf6ac` · **Branch:** `main` · **Test corpus:** 559 Vitest tests / 52 spec
...
The 559 figure IS a same-session recorded `npx vitest run` green result (supersedes the
