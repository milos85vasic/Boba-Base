...
- **517 automated tests pass** (across 48 test files); the code also passes its type
...
**HEAD:** `5edf6ac` · **Branch:** `main` · **Test corpus:** 517 Vitest tests / 48 spec
...
The 517 figure IS a same-session recorded `npx vitest run` green result (supersedes the
