...
- **527 automated tests pass** (across 49 test files); the code also passes its type
...
**HEAD:** `5edf6ac` · **Branch:** `main` · **Test corpus:** 527 Vitest tests / 49 spec
...
The 527 figure IS a same-session recorded `npx vitest run` green result (supersedes the
