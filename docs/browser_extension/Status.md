...
**Revision:** 8
**Last modified:** 2026-06-10T23:00:00Z
...
- **Extension test corpus:** **527 Vitest tests across 49 spec files** — same-session
  `npx vitest run` → `Tests 527 passed (527)` — under
...
- The 527 figure IS a same-session recorded `npx vitest run` result (`Tests 527 passed (527)`),
