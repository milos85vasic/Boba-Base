...
- Live captures: `docs/qa/BOB-076/` (to be created — `journalctl_20-45_to_20-52.log`, `oomctl_snapshot.log`, `cgtop_snapshot.log`, `psi_readings.log`, `ps_LRSS_snapshot.log`, `challenge_pass.log`, `challenge_polarity_forced_fail.log`)
